...
class EsewaVerifyView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        reference_id=EsewaTransaction.objects.filter(reference_id=request.data['reference_id'])
        if reference_id.exists():
            response = self.service.verify_transaction(credential, request.data['reference_id'])
